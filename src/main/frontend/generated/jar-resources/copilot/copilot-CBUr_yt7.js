...
const mn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), Ve = "copilot-", sl = "24.9.13", ll = "undefined", $u = "attention-required", Du = "https://plugins.jetbrains.com/plugin/23758-vaadin", ku = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Tu = "https://marketplace.eclipse.org/content/vaadin-tools";
function Iu(e) {
...
function cc() {
  Ae.push(import("./copilot-log-plugin-DrBGmOGh.js")), Ae.push(import("./copilot-info-plugin-SOYnw0kJ.js")), Ae.push(import("./copilot-features-plugin-CG8YmHtF.js")), Ae.push(import("./copilot-feedback-plugin-3a5RS9bN.js")), Ae.push(import("./copilot-shortcuts-plugin-Dft_vyQA.js"));
}
function uc() {
  {
...
let vi = class extends lc {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-cJhCYJ4m.js"), await import("./copilot-init-step2-Bg6kBI1W.js"), ml(), cc(), this.tabIndex = 0, Vt.hostConnectedCallback(), window.addEventListener("keydown", Kn), this.addEventListener("keydown", pi), y.onSend(this.handleSendEvent), this.removers.push(y.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
